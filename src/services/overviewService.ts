...
export const overviewService = {
  getOverview: async (params?: { organizationId?: string; storeId?: string; storeIds?: string[]; platform?: string; startDate?: string; endDate?: string }): Promise<OverviewResponse> => {
